				...
				<div class="panel panel-success">
					<div class="panel-heading">
						<h3 class="panel-title"><span class="fa fa-road"></span> 途径站点</h3>
					</div>
					<div class="list-group">
					<?php for ($i = 0; $i < $this->data['totalStops']; $i++): ?>
						<a href="./index.php?mod=stopinfo&id=<?php print $this->data['stops'][$i]['stop_id']; ?>" class="list-group-item"><span class="badge"><?php print $this->data['stops'][$i]['stop_sort']; ?></span> <span class="fa fa-map-marker"></span> <?php print $this->data['stops'][$i]['stop_name']; ?></a>
					<?php endfor; ?>
					</div>
				</div>